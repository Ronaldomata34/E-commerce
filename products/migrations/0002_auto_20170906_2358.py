# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-06 23:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_of_product', to='products.Category'),
        ),
        migrations.AlterField(
            model_name='product',
            name='platform',
